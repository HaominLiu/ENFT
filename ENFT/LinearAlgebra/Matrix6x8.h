...
namespace LA
{
	...
	protected:
		...
		__m128 m_30_31_32_33, m_34_35_36_37;
		__m128 m_40_41_42_43, m_44_45_46_47;
		__m128 m_50_51_52_53, m_54_55_56_57;

	};

	inline void ATBT(const AlignedVector8f &A, AlignedMatrix6x8f &B, AlignedVector6f &ATBT)
	{
		ATBT.v0() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_00_01_02_03()), _mm_mul_ps(A.v4567(), B.M_04_05_06_07())));
		ATBT.v1() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_10_11_12_13()), _mm_mul_ps(A.v4567(), B.M_14_15_16_17())));
		ATBT.v2() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_20_21_22_23()), _mm_mul_ps(A.v4567(), B.M_24_25_26_27())));
		ATBT.v3() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_30_31_32_33()), _mm_mul_ps(A.v4567(), B.M_34_35_36_37())));
		ATBT.v4() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_40_41_42_43()), _mm_mul_ps(A.v4567(), B.M_44_45_46_47())));
		ATBT.v5() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.v0123(), B.M_50_51_52_53()), _mm_mul_ps(A.v4567(), B.M_54_55_56_57())));
	}
