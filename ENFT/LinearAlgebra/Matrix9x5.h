...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_64_x_x_x() const { return m_64_x_x_x; }			inline __m128& M_64_x_x_x() { return m_64_x_x_x; }
		inline const __m128& M_74_x_x_x() const { return m_74_x_x_x; }			inline __m128& M_74_x_x_x() { return m_74_x_x_x; }
		inline const __m128& M_84_x_x_x() const { return m_84_x_x_x; }			inline __m128& M_84_x_x_x() { return m_84_x_x_x; }
		...
		{
			MT.M_00_01_02_03() = _mm_setr_ps(M00(), M10(), M20(), M30());	MT.M_04_05_06_07() = _mm_setr_ps(M40(), M50(), M60(), M70());	MT.M08() = M80();
			MT.M_10_11_12_13() = _mm_setr_ps(M01(), M11(), M21(), M31());	MT.M_14_15_16_17() = _mm_setr_ps(M41(), M51(), M61(), M71());	MT.M18() = M81();
			MT.M_20_21_22_23() = _mm_setr_ps(M02(), M12(), M22(), M32());	MT.M_24_25_26_27() = _mm_setr_ps(M42(), M52(), M62(), M72());	MT.M28() = M82();
			MT.M_30_31_32_33() = _mm_setr_ps(M03(), M13(), M23(), M33());	MT.M_34_35_36_37() = _mm_setr_ps(M43(), M53(), M63(), M73());	MT.M38() = M83();
			MT.M_40_41_42_43() = _mm_setr_ps(M04(), M14(), M24(), M34());	MT.M_44_45_46_47() = _mm_setr_ps(M44(), M54(), M64(), M74());	MT.M48() = M84();
		}

	protected:

		__m128 m_60_61_62_63, m_64_x_x_x, m_70_71_72_73, m_74_x_x_x, m_80_81_82_83, m_84_x_x_x;

	};

	inline void AddAij2To(const AlignedMatrix9x5f &A, AlignedVector5f &to)
	{
		to.v0123() = _mm_add_ps(_mm_add_ps(_mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_00_01_02_03()), _mm_mul_ps(A.M_10_11_12_13(), A.M_10_11_12_13())), 
													  _mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), A.M_20_21_22_23()), _mm_mul_ps(A.M_30_31_32_33(), A.M_30_31_32_33()))), 
										   _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_40_41_42_43(), A.M_40_41_42_43()), _mm_mul_ps(A.M_50_51_52_53(), A.M_50_51_52_53())), 
													  _mm_add_ps(_mm_mul_ps(A.M_60_61_62_63(), A.M_60_61_62_63()), _mm_mul_ps(A.M_70_71_72_73(), A.M_70_71_72_73())))), 
													  _mm_add_ps(_mm_mul_ps(A.M_80_81_82_83(), A.M_80_81_82_83()), to.v0123()));
