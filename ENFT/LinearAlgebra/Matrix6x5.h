...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_54_x_x_x() const { return m_54_x_x_x; }			inline __m128& M_54_x_x_x() { return m_54_x_x_x; }
		...
		{
			MT.M_00_01_02_03() = _mm_setr_ps(M00(), M10(), M20(), M30());	MT.M04() = M40();	MT.M05() = M50();
			MT.M_10_11_12_13() = _mm_setr_ps(M01(), M11(), M21(), M31());	MT.M14() = M41();	MT.M15() = M51();
			MT.M_20_21_22_23() = _mm_setr_ps(M02(), M12(), M22(), M32());	MT.M24() = M42();	MT.M25() = M52();
			MT.M_30_31_32_33() = _mm_setr_ps(M03(), M13(), M23(), M33());	MT.M34() = M43();	MT.M35() = M53();
			MT.M_40_41_42_43() = _mm_setr_ps(M04(), M14(), M24(), M34());	MT.M44() = M44();	MT.M45() = M54();
		}
	...
	protected:
		...
		__m128 m_50_51_52_53, m_54_x_x_x;
