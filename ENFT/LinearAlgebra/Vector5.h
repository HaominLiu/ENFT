...
namespace LA
{
	...
	public:
		...
		inline const __m128 &v4xxx() const { return m_4xxx; }				inline __m128 &v4xxx () { return m_4xxx; }
		...
		inline void SetZero() { v0123() = _mm_setzero_ps(); v4() = 0.0f; }
		...
		inline float SquaredLength() const { return SSE::Sum0123(_mm_mul_ps(v0123(), v0123())) + v4() * v4(); }
		inline float Dot(const AlignedVector5f &v) const { return SSE::Sum0123(_mm_mul_ps(v0123(), v.v0123())) + v4() * v.v4(); }
		inline void Print() const { printf("%f, %f, %f, %f %f\n", v0(), v1(), v2(), v3(), v4()); }
	protected:
		__m128 m_0123, m_4xxx;
	};
	...
	{
		return SSE::Sum0123(_mm_mul_ps(v.v0123(), _mm_mul_ps(v.v0123(), w.v0123()))) + v.v4() * v.v4() * w.v4();
	}
