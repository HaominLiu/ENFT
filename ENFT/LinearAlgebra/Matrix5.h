...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_24_x_x_x() const { return m_24_x_x_x; }			inline __m128& M_24_x_x_x() { return m_24_x_x_x; }
		inline const __m128& M_34_x_x_x() const { return m_34_x_x_x; }			inline __m128& M_34_x_x_x() { return m_34_x_x_x; }
		inline const __m128& M_44_x_x_x() const { return m_44_x_x_x; }			inline __m128& M_44_x_x_x() { return m_44_x_x_x; }
	...
	protected:
		...
		__m128 m_00_01_02_03, m_04_x_x_x, m_10_11_12_13, m_14_x_x_x, m_20_21_22_23, m_24_x_x_x, m_30_31_32_33, m_34_x_x_x, m_40_41_42_43, m_44_x_x_x;
	...
	{
		AB.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + A.M04() * B.v4();
		AB.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + A.M14() * B.v4();
		AB.v2() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), B.v0123())) + A.M24() * B.v4();
		AB.v3() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), B.v0123())) + A.M34() * B.v4();
		AB.v4() = SSE::Sum0123(_mm_mul_ps(A.M_40_41_42_43(), B.v0123())) + A.M44() * B.v4();
	}
	inline void AddATAToUpper(const AlignedMatrix2x5f &A, AlignedMatrix5f &to)
	{
		to.M_00_01_02_03() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M00()), A.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M10()), A.M_10_11_12_13())), to.M_00_01_02_03());
		to.M04() = A.M00() * A.M04() + A.M10() * A.M14() + to.M04();

		to.M_10_11_12_13() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M01()), A.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M11()), A.M_10_11_12_13())), to.M_10_11_12_13());
	...
	{
		A.M_00_01_02_03() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v0()), s.v0123()), A.M_00_01_02_03());		A.M04() *= s.v0() * s.v4();
		A.M_10_11_12_13() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v1()), s.v0123()), A.M_10_11_12_13());		A.M14() *= s.v1() * s.v4();
		A.M_20_21_22_23() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v2()), s.v0123()), A.M_20_21_22_23());		A.M24() *= s.v2() * s.v4();
		A.M_30_31_32_33() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v3()), s.v0123()), A.M_30_31_32_33());		A.M34() *= s.v3() * s.v4();
		A.M_40_41_42_43() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v4()), s.v0123()), A.M_40_41_42_43());		A.M44() *= s.v4() * s.v4();
	}
