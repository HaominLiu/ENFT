...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_04_05_06_x () const { return m_04_05_06_x; }			inline __m128& M_04_05_06_x () { return m_04_05_06_x; }
		inline const __m128& M_10_11_12_13() const { return m_10_11_12_13; }		inline __m128& M_10_11_12_13() { return m_10_11_12_13; }
		inline const __m128& M_14_15_16_x () const { return m_14_15_16_x; }			inline __m128& M_14_15_16_x () { return m_14_15_16_x; }
	...
	protected:
		...
		__m128 m_00_01_02_03, m_04_05_06_x;
		__m128 m_10_11_12_13, m_14_15_16_x;
	...
	inline void AddAij2To(const AlignedMatrix2x7f &A, AlignedVector7f &to)
	{
		...
		to.v456x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_04_05_06_x (), A.M_04_05_06_x ()), _mm_mul_ps(A.M_14_15_16_x (), A.M_14_15_16_x ())), to.v456x());
	}

	inline void AddATBTo(const AlignedMatrix2x7f &A, const Vector2f &B, AlignedVector7f &to, __m128 *work2)
	{
		...
		to.v456x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_04_05_06_x (), work2[0]), _mm_mul_ps(A.M_14_15_16_x (), work2[1])), to.v456x());
	}
	template<> inline void FinishAdditionATBTo<AlignedMatrix2x7f>(AlignedVector7f &to) { to.reserve() = 0.0f; }
	inline void SubtractATBFrom(const AlignedMatrix2x7f &A, const Vector2f &B, AlignedVector7f &from, __m128 *work2)
	{
		work2[0] = _mm_set1_ps(B.v0());		work2[1] = _mm_set1_ps(B.v1());
		from.v0123() = _mm_sub_ps(from.v0123(), _mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), work2[0]), _mm_mul_ps(A.M_10_11_12_13(), work2[1])));
		from.v456x() = _mm_sub_ps(from.v456x(), _mm_add_ps(_mm_mul_ps(A.M_04_05_06_x (), work2[0]), _mm_mul_ps(A.M_14_15_16_x (), work2[1])));
	}
	inline void AddATBTo(const AlignedMatrix2f &A, const AlignedMatrix2x7f &B, AlignedMatrix2x7f &to, __m128 *work2)
	{
	...
	inline void ATB(const AlignedMatrix2f &A, const AlignedMatrix2x7f &B, AlignedMatrix2x7f &ATB, __m128 *work2)
	{
		work2[0] = _mm_set1_ps(A.M00());
		work2[1] = _mm_set1_ps(A.M10());
	...
	inline void s1s2TA(const Vector2f &s1, const AlignedVector7f &s2, AlignedMatrix2x7f &A, __m128 &work)
	{
	...
	inline void AddABTo(const AlignedMatrix2x7f &A, const AlignedVector7f &B, Vector2f &to, __m128 *work0)
	{
#if _DEBUG
		assert(B.reserve() == 0);
#endif
	...
	inline void SubtractABFrom(const AlignedMatrix2x7f &A, const AlignedVector7f &B, Vector2f &from, __m128 *work0)
	{
#if _DEBUG
		assert(B.reserve() == 0);
#endif
	...
	public:
		...
		inline const __m128& M_06_16_x_x() const { return m_06_16_x_x; }		inline __m128& M_06_16_x_x() { return m_06_16_x_x; }
	...
	inline void AddAij2To(const AlignedCompactMatrix2x7f &A, AlignedVector7f &to, __m128 *work1)
	{
		to.v0123() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_00_01_02_03()), _mm_mul_ps(A.M_10_11_12_13(), A.M_10_11_12_13())), to.v0123());
		work1[0] = _mm_mul_ps(A.M_04_05_14_15(), A.M_04_05_14_15());
	...
	inline void sA(const AlignedVector7f &s, AlignedCompactMatrix2x7f &A)
	{
		...
		A.M_04_05_14_15() = _mm_mul_ps(_mm_movelh_ps(s.v456x(), s.v456x()), A.M_04_05_14_15());
		A.M06() *= s.v6();
		A.M16() *= s.v6();
	}

	inline void AddATBTo(const AlignedCompactMatrix2x7f &A, const Vector2f &B, AlignedVector7f &to, __m128 *work2)
	{
	...
	inline void SubtractATBFrom(const AlignedCompactMatrix2x7f &A, const Vector2f &B, AlignedVector7f &from, __m128 *work2)
	{
		work2[0] = _mm_set1_ps(B.v0());
		work2[1] = _mm_set1_ps(B.v1());
		from.v0123() = _mm_sub_ps(from.v0123(), _mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), work2[0]), _mm_mul_ps(A.M_10_11_12_13(), work2[1])));
	...
	inline void AB(const AlignedCompactMatrix2x7f &A, const AlignedVector7f &B, Vector2f &AB, __m128 *work1)
	{
		work1[0] = _mm_mul_ps(A.M_04_05_14_15(), _mm_movelh_ps(B.v456x(), B.v456x()));
		AB.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + work1[0].m128_f32[0] + work1[0].m128_f32[1] + A.M06() * B.v6();
		AB.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + work1[0].m128_f32[2] + work1[0].m128_f32[3] + A.M16() * B.v6();
	}
	inline void SubtractABFrom(const AlignedCompactMatrix2x7f &A, const AlignedVector7f &B, Vector2f &from, __m128 *work1)
	{
		work1[0] = _mm_mul_ps(A.M_04_05_14_15(), _mm_movelh_ps(B.v456x(), B.v456x()));
		from.v0() -= SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + work1[0].m128_f32[0] + work1[0].m128_f32[1] + A.M06() * B.v6();
		from.v1() -= SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + work1[0].m128_f32[2] + work1[0].m128_f32[3] + A.M16() * B.v6();
	}
	template<typename TYPE>
	inline void ABpCD(const AlignedCompactMatrix2x7f &A, const AlignedVector7f &B, const Matrix2x3<TYPE> &C, const Vector3<TYPE> &D, Vector2f &ABpCD, __m128 *work1)
	{
		work1[0] = _mm_mul_ps(A.M_04_05_14_15(), _mm_movelh_ps(B.v456x(), B.v456x()));
		ABpCD.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + work1[0].m128_f32[0] + work1[0].m128_f32[1] + A.M06() * B.v6() + C.M00() * D.v0() + C.M01() * D.v1() + C.M02() * D.v2();
		ABpCD.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + work1[0].m128_f32[2] + work1[0].m128_f32[3] + A.M16() * B.v6() + C.M10() * D.v0() + C.M11() * D.v1() + C.M12() * D.v2();
	}
}
