...
namespace LA
{
	...
	public:
		...
		inline void operator *= (const __m128 &s)
		{
			...
			M_20_21_22_23() = _mm_mul_ps(s, M_20_21_22_23());
			M_30_31_32_33() = _mm_mul_ps(s, M_30_31_32_33());
		}
...
#endif
		to.M_00_01_02_03() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.v0()), A.v012x()), to.M_00_01_02_03());
		to.M_10_11_12_13() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.v1()), A.v012x()), to.M_10_11_12_13());
	...
	{
		A.M_00_01_02_03() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v0()), s.v0123()), A.M_00_01_02_03());
		A.M_10_11_12_13() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v1()), s.v0123()), A.M_10_11_12_13());
		A.M_20_21_22_23() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v2()), s.v0123()), A.M_20_21_22_23());
		A.M_30_31_32_33() = _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(s.v3()), s.v0123()), A.M_30_31_32_33());
	}
	inline void AB(const AlignedMatrix4f &A, const AlignedVector4f &B, AlignedVector4f &AB)
	{
		AB.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123()));
		AB.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123()));
		AB.v2() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), B.v0123()));
		AB.v3() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), B.v0123()));
	}
	inline void AddABTo(const AlignedMatrix4f &A, const AlignedVector4f &B, AlignedVector4f &to)
	{
		...
		to.v3() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), B.v0123())) + to.v3();
	}
