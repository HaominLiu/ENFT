...
namespace LA
{
	...
	public:
		...
		AlignedVector8f() {}
		AlignedVector8f(const float &v) { v0123() = v4567() = _mm_set1_ps(v); }
		AlignedVector8f(const __m128 &v0123, const __m128 &v4567) { m_0123 = v0123; m_4567 = v4567; }

		inline operator float* () { return (float *) this; }
		inline operator const float* () const { return (const float *) this; }
		inline const __m128& v0123() const { return m_0123; }					inline __m128& v0123() { return m_0123; }
		inline const __m128& v4567() const { return m_4567; }					inline __m128& v4567() { return m_4567; }
		...
		inline void operator *= (const __m128 &s) { v0123() = _mm_mul_ps(s, v0123()); v4567() = _mm_mul_ps(s, v4567()); }
		...
		inline float SquaredLength() const { return SSE::Sum0123(_mm_add_ps(_mm_mul_ps(v0123(), v0123()), _mm_mul_ps(v4567(), v4567()))); }
		inline float Dot(const AlignedVector8f &v) const { return SSE::Sum0123(_mm_add_ps(_mm_mul_ps(v0123(), v.v0123()), _mm_mul_ps(v4567(), v.v4567()))); }
		inline void Print() const { printf("%f %f %f %f %f %f %f %f\n", v0(), v1(), v2(), v3(), v4(), v5(), v6(), v7()); }

	protected:

		__m128 m_0123, m_4567;
	...
	{
		return SSE::Sum0123(_mm_add_ps(_mm_mul_ps(v.v0123(), _mm_mul_ps(v.v0123(), w.v0123())), _mm_mul_ps(v.v4567(), _mm_mul_ps(v.v4567(), w.v4567()))));
	}
	...
	inline void sA(const __m128 &s, const AlignedVector8f &A, AlignedVector8f &sA)
	{
		sA.v0123() = _mm_mul_ps(s, A.v0123());
		sA.v4567() = _mm_mul_ps(s, A.v4567());
	}
	inline void sApB(const __m128 &s, const AlignedVector8f &A, const AlignedVector8f &B, AlignedVector8f &sApB)
	{
