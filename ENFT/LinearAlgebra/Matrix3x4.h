...
namespace LA
{
	...
	public:
		...
		{
			return sqrt(SSE::Sum012(_mm_add_ps(_mm_mul_ps(m_00_01_02_03, m_00_01_02_03), 
									_mm_add_ps(_mm_mul_ps(m_10_11_12_13, m_10_11_12_13), 
											   _mm_mul_ps(m_20_21_22_23, m_20_21_22_23)))));
		}
	...
	protected:
		...
		__m128 m_20_21_22_23;

	};

	inline void AddATBTo(const AlignedMatrix2x3f &A, const AlignedMatrix2x4f &B, AlignedMatrix3x4f &to)
	{
		to.M_00_01_02_03() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M00()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M10()), B.M_10_11_12_13())), to.M_00_01_02_03());
		to.M_10_11_12_13() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M01()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M11()), B.M_10_11_12_13())), to.M_10_11_12_13());
		to.M_20_21_22_23() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M02()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M12()), B.M_10_11_12_13())), to.M_20_21_22_23());
	}
	...
	{
		to.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + to.v0();
		to.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + to.v1();
		to.v2() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), B.v0123())) + to.v2();
	}
	...
	{
		AB.M_00_01_02_03() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M00()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M10()), B.M_10_11_12_13())), 
												   _mm_mul_ps(_mm_set1_ps(A.M20()), B.M_20_21_22_23()));
		AB.M_10_11_12_13() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M01()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M11()), B.M_10_11_12_13())), 
												   _mm_mul_ps(_mm_set1_ps(A.M21()), B.M_20_21_22_23()));
		AB.M_20_21_22_23() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M02()), B.M_00_01_02_03()), _mm_mul_ps(_mm_set1_ps(A.M12()), B.M_10_11_12_13())), 
...
#endif
		ABT.M_00_01_02_03() = _mm_mul_ps(_mm_set1_ps(A.v0()), B.v012x());
		ABT.M_10_11_12_13() = _mm_mul_ps(_mm_set1_ps(A.v1()), B.v012x());
		ABT.M_20_21_22_23() = _mm_mul_ps(_mm_set1_ps(A.v2()), B.v012x());
	}
