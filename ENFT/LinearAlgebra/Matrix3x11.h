...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_28_29_210_x() const { return m_28_29_210_x; }		inline __m128& M_28_29_210_x() { return m_28_29_210_x; }
	...
	protected:
		...
		__m128 m_20_21_22_23, m_24_25_26_27, m_28_29_210_x;

	};

	inline void s1s2TA(const Vector3f &s1, const AlignedVector11f &s2, AlignedMatrix3x11f &A, __m128 &work)
	{
		...
		A.M_08_09_010_x() = _mm_mul_ps(_mm_mul_ps(work, s2.v8910x()), A.M_08_09_010_x());
		...
		A.M_18_19_110_x() = _mm_mul_ps(_mm_mul_ps(work, s2.v8910x()), A.M_18_19_110_x());
		...
		A.M_28_29_210_x() = _mm_mul_ps(_mm_mul_ps(work, s2.v8910x()), A.M_28_29_210_x());
	}

	inline void ATB(const SymmetricMatrix3f &A, const AlignedMatrix3x11f &B, AlignedMatrix3x11f &ATB, __m128 *work4)
	{
		...
		ATB.M_08_09_010_x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(work4[0], B.M_08_09_010_x()), _mm_mul_ps(work4[1], B.M_18_19_110_x())), 
													_mm_mul_ps(work4[2], B.M_28_29_210_x()));
		...
		ATB.M_18_19_110_x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(work4[1], B.M_08_09_010_x()), _mm_mul_ps(work4[0], B.M_18_19_110_x())), 
													_mm_mul_ps(work4[3], B.M_28_29_210_x()));
		...
		ATB.M_28_29_210_x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(work4[2], B.M_08_09_010_x()), _mm_mul_ps(work4[3], B.M_18_19_110_x())), 
													_mm_mul_ps(work4[0], B.M_28_29_210_x()));
//#if _DEBUG
...
//#endif
	...
	inline void SubtractATBFrom(const AlignedMatrix3x11f &A, const Vector3f &B, AlignedVector11f &from, __m128 *work3)
	{
		...
		from.v4567() = _mm_sub_ps(from.v4567(), _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_04_05_06_07(), work3[0]), _mm_mul_ps(A.M_14_15_16_17(), work3[1])), _mm_mul_ps(A.M_24_25_26_27(), work3[2])));
		from.v8910x() = _mm_sub_ps(from.v8910x(), _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_08_09_010_x(), work3[0]), _mm_mul_ps(A.M_18_19_110_x(), work3[1])), _mm_mul_ps(A.M_28_29_210_x(), work3[2])));
	}
	inline void SubtractABFrom(const AlignedMatrix2x3f &A, AlignedMatrix3x11f &B, AlignedMatrix2x11f &from, __m128 *work3)
	{
		...
		from.M_08_09_010_x() = _mm_sub_ps(from.M_08_09_010_x(), _mm_add_ps(_mm_add_ps(_mm_mul_ps(work3[0], B.M_08_09_010_x()), _mm_mul_ps(work3[1], B.M_18_19_110_x())), 
																					  _mm_mul_ps(work3[2], B.M_28_29_210_x())));
		...
		from.M_14_15_16_17() = _mm_sub_ps(from.M_14_15_16_17(), _mm_add_ps(_mm_add_ps(_mm_mul_ps(work3[0], B.M_04_05_06_07()), _mm_mul_ps(work3[1], B.M_14_15_16_17())), 
																					  _mm_mul_ps(work3[2], B.M_24_25_26_27())));
		from.M_18_19_110_x() = _mm_sub_ps(from.M_18_19_110_x(), _mm_add_ps(_mm_add_ps(_mm_mul_ps(work3[0], B.M_08_09_010_x()), _mm_mul_ps(work3[1], B.M_18_19_110_x())), 
																					  _mm_mul_ps(work3[2], B.M_28_29_210_x())));
	}
...
#endif
		from.v0() -= SSE::Sum0123(_mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), B.v0123()), _mm_mul_ps(A.M_04_05_06_07(), B.v4567())), 
														_mm_mul_ps(A.M_08_09_010_x(), B.v8910x())));
		from.v1() -= SSE::Sum0123(_mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), B.v0123()), _mm_mul_ps(A.M_14_15_16_17(), B.v4567())), 
														_mm_mul_ps(A.M_18_19_110_x(), B.v8910x())));
		from.v2() -= SSE::Sum0123(_mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), B.v0123()), _mm_mul_ps(A.M_24_25_26_27(), B.v4567())), 
														_mm_mul_ps(A.M_28_29_210_x(), B.v8910x())));
	}
	inline void SubtractABFrom(const AlignedMatrix3x11f &A, const AlignedVector11f &B, Vector3f &from, __m128 *work0) { SubtractABFrom(A, B, from); }
