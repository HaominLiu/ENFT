...
namespace LA
{
	...
	protected:
		...
		__m128 m_00_01_02_03, m_04_05_06_07, m_08_x_x_x;
		__m128 m_10_11_12_13, m_14_15_16_17, m_18_x_x_x;
		__m128 m_20_21_22_23, m_24_25_26_27, m_28_x_x_x;
		__m128 m_30_31_32_33, m_34_35_36_37, m_38_x_x_x;
		__m128 m_40_41_42_43, m_44_45_46_47, m_48_x_x_x;

	};

	inline void AddAATToUpper(const AlignedMatrix5x9f &A, AlignedMatrix5f &to)
	{
		to.M00() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_00_01_02_03()), _mm_mul_ps(A.M_04_05_06_07(), A.M_04_05_06_07()))) + A.M08() * A.M08() + to.M00();
		to.M01() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_10_11_12_13()), _mm_mul_ps(A.M_04_05_06_07(), A.M_14_15_16_17()))) + A.M08() * A.M18() + to.M01();
		to.M02() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_20_21_22_23()), _mm_mul_ps(A.M_04_05_06_07(), A.M_24_25_26_27()))) + A.M08() * A.M28() + to.M02();
		to.M03() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_30_31_32_33()), _mm_mul_ps(A.M_04_05_06_07(), A.M_34_35_36_37()))) + A.M08() * A.M38() + to.M03();
		to.M04() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_40_41_42_43()), _mm_mul_ps(A.M_04_05_06_07(), A.M_44_45_46_47()))) + A.M08() * A.M48() + to.M04();

		to.M11() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), A.M_10_11_12_13()), _mm_mul_ps(A.M_14_15_16_17(), A.M_14_15_16_17()))) + A.M18() * A.M18() + to.M11();
		to.M12() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), A.M_20_21_22_23()), _mm_mul_ps(A.M_14_15_16_17(), A.M_24_25_26_27()))) + A.M18() * A.M28() + to.M12();
		to.M13() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), A.M_30_31_32_33()), _mm_mul_ps(A.M_14_15_16_17(), A.M_34_35_36_37()))) + A.M18() * A.M38() + to.M13();
		to.M14() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), A.M_40_41_42_43()), _mm_mul_ps(A.M_14_15_16_17(), A.M_44_45_46_47()))) + A.M18() * A.M48() + to.M14();

		to.M22() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), A.M_20_21_22_23()), _mm_mul_ps(A.M_24_25_26_27(), A.M_24_25_26_27()))) + A.M28() * A.M28() + to.M22();
		to.M23() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), A.M_30_31_32_33()), _mm_mul_ps(A.M_24_25_26_27(), A.M_34_35_36_37()))) + A.M28() * A.M38() + to.M23();
		to.M24() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), A.M_40_41_42_43()), _mm_mul_ps(A.M_24_25_26_27(), A.M_44_45_46_47()))) + A.M28() * A.M48() + to.M24();

		to.M33() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_30_31_32_33(), A.M_30_31_32_33()), _mm_mul_ps(A.M_34_35_36_37(), A.M_34_35_36_37()))) + A.M38() * A.M38() + to.M33();
		to.M34() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_30_31_32_33(), A.M_40_41_42_43()), _mm_mul_ps(A.M_34_35_36_37(), A.M_44_45_46_47()))) + A.M38() * A.M48() + to.M34();

		to.M44() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_40_41_42_43(), A.M_40_41_42_43()), _mm_mul_ps(A.M_44_45_46_47(), A.M_44_45_46_47()))) + A.M48() * A.M48() + to.M44();
	}
	inline void AddABTo(const AlignedMatrix5x9f &A, const AlignedVector9f &B, AlignedVector5f &to)
	{
		to.v0() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), B.v0123()), _mm_mul_ps(A.M_04_05_06_07(), B.v4567()))) + A.M08() * B.v8() + to.v0();
		to.v1() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_10_11_12_13(), B.v0123()), _mm_mul_ps(A.M_14_15_16_17(), B.v4567()))) + A.M18() * B.v8() + to.v1();
		to.v2() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_20_21_22_23(), B.v0123()), _mm_mul_ps(A.M_24_25_26_27(), B.v4567()))) + A.M28() * B.v8() + to.v2();
		to.v3() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_30_31_32_33(), B.v0123()), _mm_mul_ps(A.M_34_35_36_37(), B.v4567()))) + A.M38() * B.v8() + to.v3();
		to.v4() = SSE::Sum0123(_mm_add_ps(_mm_mul_ps(A.M_40_41_42_43(), B.v0123()), _mm_mul_ps(A.M_44_45_46_47(), B.v4567()))) + A.M48() * B.v8() + to.v4();
	}
