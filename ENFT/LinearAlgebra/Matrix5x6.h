...
namespace LA
{
	...
	public:
		...
		inline const __m128& M_34_35_x_x  () const { return m_34_35_x_x; }			inline __m128& M_34_35_x_x  () { return m_34_35_x_x; }
		inline const __m128& M_40_41_42_43() const { return m_40_01_02_03; }		inline __m128& M_40_41_42_43() { return m_40_01_02_03; }
		inline const __m128& M_44_45_x_x  () const { return m_44_45_x_x; }			inline __m128& M_44_45_x_x  () { return m_44_45_x_x; }
	...
	protected:
		...
		__m128 m_20_21_22_23, m_24_25_x_x, m_30_31_32_33, m_34_35_x_x, m_40_01_02_03, m_44_45_x_x;

	};

	inline void AddAATToUpper(const AlignedMatrix5x6f &A, AlignedMatrix5f &to)
	{
		to.M00() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), A.M_00_01_02_03())) + A.M04() * A.M04() + A.M05() * A.M05() + to.M00();
		to.M01() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), A.M_10_11_12_13())) + A.M04() * A.M14() + A.M05() * A.M15() + to.M01();
		to.M02() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), A.M_20_21_22_23())) + A.M04() * A.M24() + A.M05() * A.M25() + to.M02();
		to.M03() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), A.M_30_31_32_33())) + A.M04() * A.M34() + A.M05() * A.M35() + to.M03();
		to.M04() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), A.M_40_41_42_43())) + A.M04() * A.M44() + A.M05() * A.M45() + to.M04();

		to.M11() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), A.M_10_11_12_13())) + A.M14() * A.M14() + A.M15() * A.M15() + to.M11();
		to.M12() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), A.M_20_21_22_23())) + A.M14() * A.M24() + A.M15() * A.M25() + to.M12();
		to.M13() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), A.M_30_31_32_33())) + A.M14() * A.M34() + A.M15() * A.M35() + to.M13();
		to.M14() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), A.M_40_41_42_43())) + A.M14() * A.M44() + A.M15() * A.M45() + to.M14();

		to.M22() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), A.M_20_21_22_23())) + A.M24() * A.M24() + A.M25() * A.M25() + to.M22();
		to.M23() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), A.M_30_31_32_33())) + A.M24() * A.M34() + A.M25() * A.M35() + to.M23();
		to.M24() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), A.M_40_41_42_43())) + A.M24() * A.M44() + A.M25() * A.M45() + to.M24();

		to.M33() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), A.M_30_31_32_33())) + A.M34() * A.M34() + A.M35() * A.M35() + to.M33();
		to.M34() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), A.M_40_41_42_43())) + A.M34() * A.M44() + A.M35() * A.M45() + to.M34();

		to.M44() = SSE::Sum0123(_mm_mul_ps(A.M_40_41_42_43(), A.M_40_41_42_43())) + A.M44() * A.M44() + A.M45() * A.M45() + to.M44();
	}
	inline void AddABTo(const AlignedMatrix5x6f &A, const AlignedVector6f &B, AlignedVector5f &to)
	{
		to.v0() = SSE::Sum0123(_mm_mul_ps(A.M_00_01_02_03(), B.v0123())) + A.M04() * B.v4() + A.M05() * B.v5() + to.v0();
		to.v1() = SSE::Sum0123(_mm_mul_ps(A.M_10_11_12_13(), B.v0123())) + A.M14() * B.v4() + A.M15() * B.v5() + to.v1();
		to.v2() = SSE::Sum0123(_mm_mul_ps(A.M_20_21_22_23(), B.v0123())) + A.M24() * B.v4() + A.M25() * B.v5() + to.v2();
		to.v3() = SSE::Sum0123(_mm_mul_ps(A.M_30_31_32_33(), B.v0123())) + A.M34() * B.v4() + A.M35() * B.v5() + to.v3();
		to.v4() = SSE::Sum0123(_mm_mul_ps(A.M_40_41_42_43(), B.v0123())) + A.M44() * B.v4() + A.M45() * B.v5() + to.v4();
	}
