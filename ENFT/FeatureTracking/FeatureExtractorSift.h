...
#include "FillMap.h"
#include "ProgramGLSample.h"
#include "ProgramGLFilterPacked.h"
#include "ProgramGLGradient.h"
#include "ProgramGLDoG.h"
#include "ProgramGLDoGExtremum.h"
#include "ProgramGLFeatureHistogram.h"
#include "ProgramGLFeatureLocalize.h"
#include "ProgramGLFeatureRearrange.h"
#include "ProgramGLFeatureCopy.h"
#include "ProgramGLFeatureSelect.h"
#include "ProgramGLAssignOrientation.h"
#include "ProgramGLDescriptorGenerate.h"
#include "ProgramGLDescriptorRearrange.h"
#include "ProgramGLDescriptorNormalize.h"
#include "ProgramGLDescriptorCopy.h"
#include "ProgramGLDescriptorSelect.h"
#include <CVD/image.h>
...
//	inline void UploadIndexesFromCPU(const std::vector<float> &idxs)
//	{
//		const uint nFtrs = uint(idxs.size());
//		UploadIndexesFromCPU(m_idxTex, nFtrs, idxs.data());
//	}
	inline void UploadFeaturesAndDescriptorsFromCPU(const ushort &iBuffer, const AlignedVector<Point2D> &ftrs, const AlignedVector<Descriptor> &descs)
	{
		...
		//m_nFtrsTotal[iBuffer] = m_nFtrsOctave[iBuffer][0] = m_nFtrsLevel[iBuffer][0][0] = uint(ftrs.Size());
	...
	inline void PushBackFeaturesAndDescriptorsFromCPU(const ushort &iBuffer, const uint &nFtrs, const Point2D *ftrs, const Descriptor *descs)
	{
		...
		//m_nFtrsOctave[iBuffer][0] += nFtrs;
		//m_nFtrsLevel[iBuffer][0][0] += nFtrs;
		m_nFtrsOctave[iBuffer].assign(m_nFtrsOctave[iBuffer].size(), 0);
		m_nFtrsLevel[iBuffer].SetZero();
	}
