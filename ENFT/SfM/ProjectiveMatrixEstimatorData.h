...
public:
	...
	virtual void ConstructNormalEquation(const ProjectiveMatrix &P, LA::AlignedMatrix11f &A, LA::AlignedVector11f &b, LA::AlignedVector11f &s)
	{
		...
		b.SetZero();
		s.SetZero();
		m_J.M_04_05_06_07() = m_J.M_10_11_12_13() = _mm_setzero_ps();
		const ushort N = Size();
		for(ushort i = 0; i < N; ++i)
		{
			...
			m_J.M_00_01_02_03() = m_J.M_14_15_16_17() = _mm_mul_ps(m_work[0], X.XYZx());
			m_J.M_08_09_010_x() = _mm_mul_ps(m_work[1], X.XYZx());
			m_J.M_18_19_110_x() = _mm_mul_ps(m_work[2], X.XYZx());
			LA::AmB(m_xs[i], x, e);
	...
	{
		Pnew.M_00_01_02_03() = _mm_add_ps(_mm_mul_ps(s.v0123(), x.v0123()), Pold.M_00_01_02_03());
		Pnew.M_10_11_12_13() = _mm_add_ps(_mm_mul_ps(s.v4567(), x.v4567()), Pold.M_10_11_12_13());
		Pnew.M_20_21_22_23() = _mm_add_ps(_mm_mul_ps(s.v8910x(), x.v8910x()), Pold.M_20_21_22_23());
#if _DEBUG
...
protected:
	...
	static inline void AddATAToUpper(const LA::AlignedMatrix2x11f &A, LA::AlignedMatrix11f &to, __m128 &work)
	{
		work = _mm_set1_ps(A.M00());
		to.M_00_01_02_03() = _mm_add_ps(_mm_mul_ps(work, A.M_00_01_02_03()), to.M_00_01_02_03());
		to.M_08_09_010_x() = _mm_add_ps(_mm_mul_ps(work, A.M_08_09_010_x()), to.M_08_09_010_x());
		work = _mm_set1_ps(A.M01());
		to.M_10_11_12_13() = _mm_add_ps(_mm_mul_ps(work, A.M_00_01_02_03()), to.M_10_11_12_13());
		to.M_18_19_110_x() = _mm_add_ps(_mm_mul_ps(work, A.M_08_09_010_x()), to.M_18_19_110_x());
		to.M22() = A.M02() * A.M02() + to.M22();
		to.M23() = A.M02() * A.M03() + to.M23();
		to.M_28_29_210_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M02()), A.M_08_09_010_x()), to.M_28_29_210_x());
		to.M33() = A.M03() * A.M03() + to.M33();
		to.M_38_39_310_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M03()), A.M_08_09_010_x()), to.M_38_39_310_x());
		to.M_48_49_410_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M14()), A.M_18_19_110_x()), to.M_48_49_410_x());
		to.M_58_59_510_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M15()), A.M_18_19_110_x()), to.M_58_59_510_x());
		to.M_68_69_610_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M16()), A.M_18_19_110_x()), to.M_68_69_610_x());
		to.M_78_79_710_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M17()), A.M_18_19_110_x()), to.M_78_79_710_x());
		to.M_88_89_810_x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.M08()), A.M_08_09_010_x()), _mm_mul_ps(_mm_set1_ps(A.M18()), A.M_18_19_110_x())), to.M_88_89_810_x());
	...
	static inline void AddATBTo(const LA::AlignedMatrix2x11f &A, const LA::Vector2f &B, LA::AlignedVector11f &to, __m128 *work2)
	{
		work2[0] = _mm_set1_ps(B.v0());
		work2[1] = _mm_set1_ps(B.v1());
		to.v0123() = _mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), work2[0]), to.v0123());
		to.v4567() = _mm_add_ps(_mm_mul_ps(A.M_14_15_16_17(), work2[1]), to.v4567());
	...
	{
		to.v0123() = _mm_add_ps(_mm_mul_ps(A.M_00_01_02_03(), A.M_00_01_02_03()), to.v0123());
		to.v8910x() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(A.M_08_09_010_x(), A.M_08_09_010_x()), _mm_mul_ps(A.M_18_19_110_x(), A.M_18_19_110_x())), to.v8910x());
	}
...
public:
	...
	virtual void UpdateModel(const LA::AlignedVector7f &s, const LA::AlignedVector7f &x, const ProjectiveMatrixMetric &Pold, ProjectiveMatrixMetric &Pnew)
	{
		...
		m_work[0] = _mm_mul_ps(s.v456x(), x.v456x());
