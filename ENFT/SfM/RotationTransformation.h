...
public:
	...
	inline const __m128& r_00_01_10_11() const { return M_00_01_10_11(); }
	inline		 __m128& r_00_01_10_11()	   { return M_00_01_10_11(); }
...
public:
	...
	static inline void AccumulateTransformation(const RotationTransformation2D &R1, const RotationTransformation2D &R12, RotationTransformation2D &R2, 
												__m128 *work2)
	{
		work2[0] = _mm_mul_ps(R12.r_00_01_10_11(), _mm_setr_ps(R1.r00(), R1.r10(), R1.r00(), R1.r10()));
		work2[1] = _mm_mul_ps(R12.r_00_01_10_11(), _mm_setr_ps(R1.r01(), R1.r11(), R1.r01(), R1.r11()));
...
public:
	...
	inline const __m128& r_00_01_02_x() const { return M_00_01_02_x(); }		inline __m128& r_00_01_02_x() { return M_00_01_02_x(); }
	inline const __m128& r_10_11_12_x() const { return M_10_11_12_x(); }		inline __m128& r_10_11_12_x() { return M_10_11_12_x(); }
	inline const __m128& r_20_21_22_x() const { return M_20_21_22_x(); }		inline __m128& r_20_21_22_x() { return M_20_21_22_x(); }
	inline const float& r00() const { return M00(); }		inline float& r00() { return M00(); }
	inline const float& r01() const { return M01(); }		inline float& r01() { return M01(); }
	...
	{
		RX_X = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), X.XYZx()));
		RX_Y = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), X.XYZx()));
		RX_Z = SSE::Sum012(_mm_mul_ps(r_20_21_22_x(), X.XYZx()));
	}
	inline void Apply(const __m128 &X, float &RX_X, float &RX_Y, float &RX_Z) const
	{
		RX_X = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), X));
		RX_Y = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), X));
		RX_Z = SSE::Sum012(_mm_mul_ps(r_20_21_22_x(), X));
	}
	inline void Apply(const Point3D &X, Point3D &RX) const
	{
		RX.X() = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), X.XYZx()));
		RX.Y() = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), X.XYZx()));
		RX.Z() = SSE::Sum012(_mm_mul_ps(r_20_21_22_x(), X.XYZx()));
	}
	...
	inline void Apply(const __m128 &X, __m128 &RX) const
	{
		RX.m128_f32[0] = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), X));
		RX.m128_f32[1] = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), X));
		RX.m128_f32[2] = SSE::Sum012(_mm_mul_ps(r_20_21_22_x(), X));
	}
	inline void ApplyInversely(const Point3D &RX, Point3D &X) const
	{
		X.XYZx() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(r_00_01_02_x(), _mm_set1_ps(RX.X())), 
										 _mm_mul_ps(r_10_11_12_x(), _mm_set1_ps(RX.Y()))), 
										 _mm_mul_ps(r_20_21_22_x(), _mm_set1_ps(RX.Z())));
		X.reserve() = 1;
	}
	inline void ApplyInversely(const Point2D &RX, Point3D &X) const
	{
		X.XYZx() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(r_00_01_02_x(), _mm_set1_ps(RX.x())), 
										 _mm_mul_ps(r_10_11_12_x(), _mm_set1_ps(RX.y()))), r_20_21_22_x());
		X.reserve() = 1;
	}
	inline void ApplyInversely(Point3D &X) const
	{
		X.XYZx() = _mm_add_ps(_mm_add_ps(_mm_mul_ps(r_00_01_02_x(), _mm_set1_ps(X.X())), 
										 _mm_mul_ps(r_10_11_12_x(), _mm_set1_ps(X.Y()))), 
										 _mm_mul_ps(r_20_21_22_x(), _mm_set1_ps(X.Z())));
		X.reserve() = 1;
	}
	...
	inline void Apply(const Point3DCovariance &P, Point3DCovariance &RPRT, __m128 *work4) const
	{
		...
		work4[3].m128_f32[0] = SSE::Sum012(_mm_mul_ps(work4[0], r_00_01_02_x()));
		work4[3].m128_f32[1] = SSE::Sum012(_mm_mul_ps(work4[1], r_00_01_02_x()));
		work4[3].m128_f32[2] = SSE::Sum012(_mm_mul_ps(work4[2], r_00_01_02_x()));
		RPRT.cXX() = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), work4[3]));

		work4[3].m128_f32[0] = SSE::Sum012(_mm_mul_ps(work4[0], r_10_11_12_x()));
		work4[3].m128_f32[1] = SSE::Sum012(_mm_mul_ps(work4[1], r_10_11_12_x()));
		work4[3].m128_f32[2] = SSE::Sum012(_mm_mul_ps(work4[2], r_10_11_12_x()));
		RPRT.cXY() = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), work4[3]));
		RPRT.cYY() = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), work4[3]));

		work4[3].m128_f32[0] = SSE::Sum012(_mm_mul_ps(work4[0], r_20_21_22_x()));
		work4[3].m128_f32[1] = SSE::Sum012(_mm_mul_ps(work4[1], r_20_21_22_x()));
		work4[3].m128_f32[2] = SSE::Sum012(_mm_mul_ps(work4[2], r_20_21_22_x()));
		RPRT.cXZ() = SSE::Sum012(_mm_mul_ps(r_00_01_02_x(), work4[3]));
		RPRT.cYZ() = SSE::Sum012(_mm_mul_ps(r_10_11_12_x(), work4[3]));
		RPRT.cZZ() = SSE::Sum012(_mm_mul_ps(r_20_21_22_x(), work4[3]));
	}
	inline void ApplyInversely(const Point3DCovariance &RPRT, Point3DCovariance &P, RotationTransformation3D &RT, __m128 *work4) const
	{
	...
	inline void LeftMultiply(const RotationTransformation3D &Rl, RotationTransformation3D &RlxR, __m128 &work) const
	{
		SSE::Set012(r00(), r10(), r20(), work);
		RlxR.r00() = SSE::Sum012(_mm_mul_ps(Rl.r_00_01_02_x(), work));
		RlxR.r10() = SSE::Sum012(_mm_mul_ps(Rl.r_10_11_12_x(), work));
		RlxR.r20() = SSE::Sum012(_mm_mul_ps(Rl.r_20_21_22_x(), work));
		SSE::Set012(r01(), r11(), r21(), work);
		RlxR.r01() = SSE::Sum012(_mm_mul_ps(Rl.r_00_01_02_x(), work));
		RlxR.r11() = SSE::Sum012(_mm_mul_ps(Rl.r_10_11_12_x(), work));
		RlxR.r21() = SSE::Sum012(_mm_mul_ps(Rl.r_20_21_22_x(), work));
		SSE::Set012(r02(), r12(), r22(), work);
		RlxR.r02() = SSE::Sum012(_mm_mul_ps(Rl.r_00_01_02_x(), work));
		RlxR.r12() = SSE::Sum012(_mm_mul_ps(Rl.r_10_11_12_x(), work));
		RlxR.r22() = SSE::Sum012(_mm_mul_ps(Rl.r_20_21_22_x(), work));
	}
	...
	inline void FromQuaternion(const __m128 &q, __m128 &work)
	{
#if _DEBUG
		const float l2 = SSE::Sum0123(_mm_mul_ps(q, q));
		assert(EQUAL(l2, 1.0f));
#endif
		work = _mm_mul_ps(_mm_set1_ps(q.m128_f32[0] + q.m128_f32[0]), q);
		r11() = r22() = 1 - work.m128_f32[0];
		r01() = r10() = work.m128_f32[1];
		r02() = r20() = work.m128_f32[2];
		r12() = work.m128_f32[3];
		r21() = -work.m128_f32[3];
		work = _mm_mul_ps(_mm_set1_ps(q.m128_f32[1] + q.m128_f32[1]), q);
