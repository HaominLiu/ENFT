...
public:
	...
	inline Quaternion() {}
	inline Quaternion(const float *q) { m_v0123 = _mm_setr_ps(q[0], q[1], q[2], q[3]); }
	inline Quaternion(const float &v0, const float &v1, const float &v2, const float &v3) { v0123() = _mm_setr_ps(v0, v1, v2, v3); }
	...
	inline void Slerp(const float &a1, const Quaternion &q1, const Quaternion &q2)
	{
		...
		v2() = sin(a1 * v0()) * v1();
		v3() = sin((1 - a1) * v0()) * v1();
		v0123() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(v2()), q1.v0123()), _mm_mul_ps(_mm_set1_ps(v3()), q2.v0123()));
	}

	inline void FromAxisAngle(const Point3D &axis, const float &angle)
	{
		v0123() = _mm_mul_ps(axis.XYZx(), _mm_set1_ps(sin(angle * 0.5f)));
		v3() = cos(angle * 0.5f);
	}
	inline void ToAxisAngle(Point3D &axis, float &angle) const
	{
		axis.Z() = SSE::Sum012(_mm_mul_ps(m_v0123, m_v0123));
		if(axis.Z() > FLT_EPSILON)
		{
			axis.XYZx() = _mm_mul_ps(_mm_set1_ps(1 / sqrt(axis.Z())), m_v0123);
			axis.reserve() = 1.0f;
			angle = acos(v3());
			angle = angle + angle;
		}
	...
	{
		L.M_00_01_02_03() = _mm_setr_ps(v3(), v2(), -v1(), v0());
		L.M_10_11_12_13() = _mm_setr_ps(-v2(), v3(), v0(), v1());
		L.M_20_21_22_23() = _mm_setr_ps(v1(), -v0(), v3(), v2());
		L.M_30_31_32_33() = _mm_setr_ps(-v0(), -v1(), -v2(), v3());
	}
	inline void ToRightMatrix(LA::AlignedMatrix4f &R) const
	{
		R.M_00_01_02_03() = _mm_setr_ps(v3(), -v2(), v1(), v0());
		R.M_10_11_12_13() = _mm_setr_ps(v2(), v3(), -v0(), v1());
		R.M_20_21_22_23() = _mm_setr_ps(-v1(), v0(), v3(), v2());
		R.M_30_31_32_33() = _mm_setr_ps(-v0(), -v1(), -v2(), v3());
	}
	static inline void Multiply(const Quaternion &q1, const Quaternion &q2, Quaternion &q1xq2)
	{
		q1xq2.v0() = SSE::Sum0123(_mm_mul_ps(_mm_setr_ps(q1.v3(), q1.v2(), -q1.v1(), q1.v0()), q2.v0123()));
		q1xq2.v1() = SSE::Sum0123(_mm_mul_ps(_mm_setr_ps(-q1.v2(), q1.v3(), q1.v0(), q1.v1()), q2.v0123()));
		q1xq2.v2() = SSE::Sum0123(_mm_mul_ps(_mm_setr_ps(q1.v1(), -q1.v0(), q1.v3(), q1.v2()), q2.v0123()));
		q1xq2.v3() = SSE::Sum0123(_mm_mul_ps(_mm_setr_ps(-q1.v0(), -q1.v1(), -q1.v2(), q1.v3()), q2.v0123()));
	}
...
public:
	...
	static inline void Multiply(const Quaternion &q1, const Quaternion &q2, __m128 &q1xq2)
	{
