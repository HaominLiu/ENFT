...
public:
	...
	bool Run(const TwoMatches3DTo2D &data, RelativeTranslation &T, AlignedVector<__m128> &work);
	bool Run(const MatchSet3DTo2DX &data, RelativeTranslation &T, AlignedVector<__m128> &work);
