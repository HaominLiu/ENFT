...
public:
	...
	//{
	//	M_00_01_02_x() = _mm_mul_ps(T.s(), T.r_00_01_10_11());
	//	M10() = M02();
	//	M11() = reserve0();
	//	M02() = T.tx();
	//	M12() = T.ty();
	...
	static inline void AccumulateTransformation(const AffineTransformation2D &T1, const AffineTransformation2D &T12, AffineTransformation2D &T2, __m128 *work0)
	{
		T2.M_00_01_02_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(T12.M00()), T1.M_00_01_02_x()), _mm_mul_ps(_mm_set1_ps(T12.M01()), T1.M_10_11_12_x()));
		T2.M_10_11_12_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(T12.M10()), T1.M_00_01_02_x()), _mm_mul_ps(_mm_set1_ps(T12.M11()), T1.M_10_11_12_x()));
		T2.M02() += T12.M02();
		T2.M12() += T12.M12();
	}
	static inline void AccumulateTransformation(const AffineTransformation2D &T1, const SimilarityTransformation2D &T12, AffineTransformation2D &T2, __m128 *work1)
	{
		work1[0] = _mm_mul_ps(T12.s(), T12.r_00_01_10_11());
		T2.M_00_01_02_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(work1[0].m128_f32[0]), T1.M_00_01_02_x()), _mm_mul_ps(_mm_set1_ps(work1[0].m128_f32[1]), T1.M_10_11_12_x()));
		T2.M_10_11_12_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(work1[0].m128_f32[2]), T1.M_00_01_02_x()), _mm_mul_ps(_mm_set1_ps(work1[0].m128_f32[3]), T1.M_10_11_12_x()));
		T2.M02() += T12.tx();
		T2.M12() += T12.ty();
	}
	...
	static inline void ChangeScale2(const float &s, const float &sinv, AffineTransformation2D &T, AffineTransformation2D &Tinv, __m128 *work1)
	{
		work1[0] = _mm_set1_ps(s);
		T.M_00_01_02_x() = _mm_mul_ps(work1[0], T.M_00_01_02_x());
		T.M_10_11_12_x() = _mm_mul_ps(work1[0], T.M_10_11_12_x());
	...
	static inline bool Invert(const LA::AlignedMatrix2x3f &T, LA::AlignedMatrix2x3f &Tinv)
	{
		if((Tinv.M00() = T.M00() * T.M11() - T.M01() * T.M10()) == 0.0f)
			return false;
		Tinv.M_00_01_02_x() = _mm_mul_ps(_mm_set1_ps(1 / Tinv.M00()), _mm_setr_ps(T.M11(), -T.M01(), -T.M10(), T.M00()));
		Tinv.M10() = Tinv.M02();
