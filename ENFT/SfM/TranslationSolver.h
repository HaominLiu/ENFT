...
public:
	...
	bool Run(const TwoMatches3DTo2D &data, Translation &T, AlignedVector<__m128> &work);
	bool Run(const MatchSet3DTo2DX &data, Translation &T, AlignedVector<__m128> &work);
