...
public:
	...
	bool Run(const SixMatches3DTo2D &data, ProjectiveMatrix &P, AlignedVector<__m128> &work);
	bool Run(const ProjectiveMatrixEstimatorData &data, ProjectiveMatrix &P, AlignedVector<__m128> &work);
