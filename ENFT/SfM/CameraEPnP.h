...
public:
	...
	bool Run(const SixMatches3DTo2D &data, Camera &C, AlignedVector<__m128> &work);
	bool Run(const CameraEstimatorData &data, Camera &C, AlignedVector<__m128> &work);

protected:

	bool ComputeCws(const SixMatches3DTo2D &data, AlignedVector<__m128> &work);
	bool ComputeCws(const CameraEstimatorData &data, AlignedVector<__m128> &work);
	bool ComputeAlphas(const SixMatches3DTo2D &data, AlignedVector<__m128> &work);
	bool ComputeAlphas(const CameraEstimatorData &data, AlignedVector<__m128> &work);
	void ConstructLinearSystem(const SixMatches3DTo2D &data, AlignedVector<__m128> &work);
	void ConstructLinearSystem(const CameraEstimatorData &data, AlignedVector<__m128> &work);
