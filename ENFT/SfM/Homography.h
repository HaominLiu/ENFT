...
public:
	...
	{
		M_20_21_22_x() = _mm_mul_ps(T.s(), T.r_00_01_10_11());
	...
	inline void Apply(const __m128 &x, __m128 &Hx) const
	{
#if _DEBUG
		assert(!IsAffineTransformation());
#endif
		Hx.m128_f32[0] = SSE::Sum012(_mm_mul_ps(M_00_01_02_x(), x));
		Hx.m128_f32[1] = SSE::Sum012(_mm_mul_ps(M_10_11_12_x(), x));
		Hx.m128_f32[2] = SSE::Sum012(_mm_mul_ps(M_20_21_22_x(), x));
	}
	...
	inline void Denormalize(const __m128 &mean_u1v1u2v2, const float &scale1, const float &scale2, __m128 *work3)
	{
#if _DEBUG
		assert(!IsAffineTransformation());
#endif
		...
		work3[2] = _mm_add_ps(_mm_mul_ps(work3[1], M_00_01_02_x()), _mm_mul_ps(_mm_set1_ps(mean_u1v1u2v2.m128_f32[2]), M_20_21_22_x()));
		M_00_01_02_x() = _mm_mul_ps(_mm_movelh_ps(work3[2], work3[2]), work3[0]);
		M02() = work3[2].m128_f32[2] - (M02() + reserve0());

		work3[2] = _mm_add_ps(_mm_mul_ps(work3[1], M_10_11_12_x()), _mm_mul_ps(_mm_set1_ps(mean_u1v1u2v2.m128_f32[3]), M_20_21_22_x()));
		M_10_11_12_x() = _mm_mul_ps(_mm_movelh_ps(work3[2], work3[2]), work3[0]);
		M12() = work3[2].m128_f32[2] - (M12() + reserve1());

		work3[2].m128_f32[2] = M22();
		M_20_21_22_x() = _mm_mul_ps(_mm_movelh_ps(M_20_21_22_x(), M_20_21_22_x()), work3[0]);
		M22() = work3[2].m128_f32[2] - (M22() + reserve2());
	}
	inline void Normalize(const __m128 &mean_u1v1u2v2, const float &scale1, const float &scale2, __m128 *work5)
	{
#if _DEBUG
		assert(!IsAffineTransformation());
#endif
		work5[0] = _mm_mul_ps(_mm_movelh_ps(_mm_set1_ps(-scale1), _mm_set1_ps(-scale2)), mean_u1v1u2v2);
		work5[1].m128_f32[0] = 1 / scale1;
		work5[1].m128_f32[1] = 1 / scale2;
		__m128 *work3 = work5 + 2;
		Denormalize(work5[0], work5[1].m128_f32[0], work5[1].m128_f32[1], work3);
	}
	inline void GetSSE(__m128 *H) const
	{
#if _DEBUG
		assert(!IsAffineTransformation());
#endif
	...
	static inline void ComputeSquaredError4(const __m128 *H, const __m128 &u1, const __m128 &v1, const __m128 &u2, const __m128 &v2, __m128 &errSq, __m128 *work2)
	{
		work2[0] = _mm_div_ps(_mm_set1_ps(1), _mm_add_ps(_mm_add_ps(_mm_mul_ps(H[6], u1), _mm_mul_ps(H[7], v1)), H[8]));
		work2[1] = _mm_sub_ps(_mm_mul_ps(_mm_add_ps(_mm_add_ps(_mm_mul_ps(H[3], u1), _mm_mul_ps(H[4], v1)), H[5]), work2[0]), v2);
		work2[0] = _mm_sub_ps(_mm_mul_ps(_mm_add_ps(_mm_add_ps(_mm_mul_ps(H[0], u1), _mm_mul_ps(H[1], v1)), H[2]), work2[0]), u2);
		errSq = _mm_add_ps(_mm_mul_ps(work2[0], work2[0]), _mm_mul_ps(work2[1], work2[1]));
	}
	static inline void ComputeSign4(const __m128 *H, const __m128 &u1, const __m128 &v1, const __m128 &u2, const __m128 &v2, __m128 &dot)
	{
		dot = _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_add_ps(_mm_add_ps(_mm_mul_ps(H[0], u1), _mm_mul_ps(H[1], v1)), H[2]), u2), 
									_mm_mul_ps(_mm_add_ps(_mm_add_ps(_mm_mul_ps(H[3], u1), _mm_mul_ps(H[4], v1)), H[5]), v2)), 
											   _mm_add_ps(_mm_add_ps(_mm_mul_ps(H[6], u1), _mm_mul_ps(H[7], v1)), H[8]));
	}

	// H12 and H2 are allowed to be the same
	static inline void AccumulateTransformation(const SimilarityTransformation2D &H1, const Homography &H12, Homography &H2, __m128 *work2)
	{
#if _DEBUG
		assert(!H12.IsAffineTransformation());
#endif
		work2[1] = _mm_mul_ps(H1.s(), H1.r_00_01_10_11());
		...
		H2.M_00_01_02_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(H12.M00()), work2[0]), _mm_mul_ps(_mm_set1_ps(H12.M01()), work2[1]));
		H2.M02() += work2[0].m128_f32[3];
		H2.M_10_11_12_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(H12.M10()), work2[0]), _mm_mul_ps(_mm_set1_ps(H12.M11()), work2[1]));
		H2.M12() += work2[1].m128_f32[3];
		work2[0].m128_f32[3] = H12.M22();
		H2.M_20_21_22_x() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(H12.M20()), work2[0]), _mm_mul_ps(_mm_set1_ps(H12.M21()), work2[1]));
	...
	// H2 = H12 * H1
	// H12 and H2 are allowed to be the same
	static inline void AccumulateTransformation(const Homography &H1, const Homography &H12, Homography &H2, __m128 *work3)
	{
#if _DEBUG
	...
	static inline void ChangeScale1(const float &s, const float &sinv, Homography &H, Homography &Hinv, __m128 *work0)
	{
	...
	static inline void ChangeScale2(const float &s, const float &sinv, Homography &H, Homography &Hinv, __m128 *work0)
	{
	...
	static bool Invert(const SimilarityTransformation2D &T, Homography &Tinv)
	{
		...
		Tinv.M_10_11_12_x() = _mm_mul_ps(_mm_set1_ps(Tinv.reserve0()), T.r_00_01_10_11());
