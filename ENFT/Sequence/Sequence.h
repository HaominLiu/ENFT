...
public:
	...
	// Transformation
	//////////////////////////////////////////////////////////////////////////
	inline void TransformCamera(const FrameIndex &iFrm, const RigidTransformation3D &T, __m128* const &work3) { T.Apply(m_Cs[iFrm], m_Cs[iFrm], work3); }
	inline void TransformCamera(const FrameIndex &iFrm, const SimilarityTransformation3D &S, __m128* const &work3) { S.Apply(m_Cs[iFrm], m_Cs[iFrm], work3); }
	inline void ScaleCamera(const FrameIndex &iFrm, const float &scale) { m_Cs[iFrm].Scale(scale); }
	inline void TransformPoint(const TrackIndex &iTrk, const RigidTransformation3D &T, __m128* const &work1) { T.Apply(m_Xs[iTrk], work1); }
	inline void TransformPoint(const TrackIndex &iTrk, const SimilarityTransformation3D &S, __m128* const &work1) { S.Apply(m_Xs[iTrk], work1); }
	inline void ScalePoint(const TrackIndex &iTrk, const __m128 &scale) { m_Xs[iTrk] *= scale; }
