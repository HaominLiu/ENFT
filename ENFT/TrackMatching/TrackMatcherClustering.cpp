...
void TrackMatcher::ClusterTracks(const SequenceSet &seqs, const SequenceIndex &iSeq1, const SequenceIndex &iSeq2, std::vector<TrackIndexListPair> &iTrkClusters)
{
...
void TrackMatcher::ClusterTracks(const SequenceSet &seqs, const SequenceIndexPairList &iSeqPairs, std::vector<std::vector<TrackIndexListPair> > &iTrkClustersList)
{
