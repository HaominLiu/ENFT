...
#include "CameraPairEstimator.h"
#include "MatchingMatrix.h"
#include "ProgramGLUtility.h"
#include "ProgramGLDescriptorNormalize.h"
#include <CVD/image.h>
...
protected:
	...
	// Basic
	//////////////////////////////////////////////////////////////////////////
	virtual void Initialize(/*const ushort &width, const ushort &height, */const ushort &maxNumFtrsPerImg, const FrameIndexList &seqFrmCnts, const Configurator &param);
	...
	// Feature matching
	//////////////////////////////////////////////////////////////////////////
	void MatchFeaturesSift(/*const */Sequence &seq1, /*const */Sequence &seq2, const FrameIndex &iFrm1, const FrameIndex &iFrm2, std::vector<ScoredMatch> &matches);
	void MatchFeaturesSift(/*const */Sequence &seq1, /*const */Sequence &seq2, const FrameIndex &iFrm1, const FrameIndex &iFrm2, const FeatureIndexList &iFtrs1, 
	...
	void MatchFeaturesSift_VerifyMatches(/*const */Sequence &seq, const FrameIndex &iFrm1, const FrameIndex &iFrm2, /*const */FeatureMatchList &matchesExist, 
		FundamentalMatrix &F, std::vector<ushort> &inliers, std::vector<ushort> &outliers, FeatureMatchList &matchesNew);
	void MatchFeaturesSift_VerifyMatches(/*const */SequenceSet &seqs, const SequenceIndex &iSeq1, const SequenceIndex &iSeq2, const FrameIndex &iFrm1, 
	...
	void VerifyMatches_MatchNewFeaturesSift(/*const */Sequence &seq, const FrameIndex &iFrm1, const FrameIndex &iFrm2, /*const */FeatureMatchList &matchesExist, 
		FundamentalMatrix &F, std::vector<ushort> &inliers, std::vector<ushort> &outliers, FeatureMatchList &matchesNew);
	void VerifyMatches_MatchNewFeaturesSift(/*const */SequenceSet &seqs, const SequenceIndex &iSeq1, const SequenceIndex &iSeq2, const FrameIndex &iFrm1, 
		const FrameIndex &iFrm2, const FeatureMatchList &matchesExist, FundamentalMatrix &F, std::vector<ushort> &inliers, std::vector<ushort> &outliers, 
		FeatureMatchList &matchesNew);
