...
public:
	...
	public:
		...
		inline const __m128& cx_cy_cz_c() const { return m_cx_cy_cz_c; }		inline __m128& cx_cy_cz_c() { return m_cx_cy_cz_c; }

		inline void Set(const float &cx, const float &cy, const float &cz, const float &c) { m_cx_cy_cz_c = _mm_set_ps(c, cz, cy, cx); }
		inline void Set(const __m128 &cx_cy_cz_c) { m_cx_cy_cz_c = cx_cy_cz_c; }
	...
	public:
		...
		inline const __m128 &cxx_cxy_cxz_cx() const { return m_cxx_cxy_cxz_cx; }	inline __m128 &cxx_cxy_cxz_cx() { return m_cxx_cxy_cxz_cx; }
		inline const __m128 &cyy_cyz_cy_czz() const { return m_cyy_cyz_cy_czz; }	inline __m128 &cyy_cyz_cy_czz() { return m_cyy_cyz_cy_czz; }
		inline const __m128 &x_x_cz_c	   () const { return m_x_x_cz_c1; }			inline __m128 &x_x_cz_c		 () { return m_x_x_cz_c1; }

	protected:

		__m128 m_cxx_cxy_cxz_cx, m_cyy_cyz_cy_czz, m_x_x_cz_c1;
	...
	public:
		...
		inline const __m128& cxxx_cxxy_cxxz_cxx() const { return m_cxxx_cxxy_cxxz_cxx; }	inline __m128& cxxx_cxxy_cxxz_cxx() { return m_cxxx_cxxy_cxxz_cxx; }
		inline const __m128& cxyy_cxyz_cxy_cxzz() const { return m_cxyy_cxyz_cxy_cxzz; }	inline __m128& cxyy_cxyz_cxy_cxzz() { return m_cxyy_cxyz_cxy_cxzz; }
		inline const __m128& cxz_cx_cyyy_cyyz  () const { return m_cxz_cx_cyyy_cyyz;   }	inline __m128& cxz_cx_cyyy_cyyz	 () { return m_cxz_cx_cyyy_cyyz;   }
		inline const __m128& cyy_cyzz_cyz_cy   () const { return m_cyy_cyzz_cyz_cy;    }	inline __m128& cyy_cyzz_cyz_cy	 () { return m_cyy_cyzz_cyz_cy;	   }
		inline const __m128& czzz_czz_cz_c	   () const { return m_czzz_czz_cz_c;	   }	inline __m128& czzz_czz_cz_c	 () { return m_czzz_czz_cz_c;	   }

	protected:

		__m128 m_cxxx_cxxy_cxxz_cxx, m_cxyy_cxyz_cxy_cxzz, m_cxz_cx_cyyy_cyyz, m_cyy_cyzz_cyz_cy, m_czzz_czz_cz_c;
	...
	public:
		...
		inline const __m128& sse0() const { return m_sse0; }				inline __m128& sse0() { return m_sse0; }
		inline const __m128& sse1() const { return m_sse1; }				inline __m128& sse1() { return m_sse1; }
		inline const __m128& sse2() const { return m_sse2; }				inline __m128& sse2() { return m_sse2; }
		inline const __m128& sse3() const { return m_sse3; }				inline __m128& sse3() { return m_sse3; }
		inline const __m128& sse4() const { return m_sse4; }				inline __m128& sse4() { return m_sse4; }

	protected:

		//__m128 m_sseCoef_x3_x2y_xy2_y3, m_sseCoef_x2z_xyz_y2z_xz2, m_sseCoef_yz2_z3_x2_xy, m_sseCoef_y2_xz_yz_z2, m_cx_cy_cz_c;
		__m128 m_sse0, m_sse1, m_sse2, m_sse3, m_sse4;
	...
	{
		ApB.cxxx_cxxy_cxxz_cxx() = _mm_add_ps(A.cxxx_cxxy_cxxz_cxx(), B.cxxx_cxxy_cxxz_cxx());
		ApB.cxyy_cxyz_cxy_cxzz() = _mm_add_ps(A.cxyy_cxyz_cxy_cxzz(), B.cxyy_cxyz_cxy_cxzz());
		ApB.cxz_cx_cyyy_cyyz  () = _mm_add_ps(A.cxz_cx_cyyy_cyyz  (), B.cxz_cx_cyyy_cyyz  ());
		ApB.cyy_cyzz_cyz_cy	  () = _mm_add_ps(A.cyy_cyzz_cyz_cy	  (), B.cyy_cyzz_cyz_cy	  ());
		ApB.czzz_czz_cz_c	  () = _mm_add_ps(A.czzz_czz_cz_c	  (), B.czzz_czz_cz_c	  ());
	}
	static inline void ApBpC(const V3E2f &A, const V3E2f &B, const V3E2f &C, V3E2f &ApBpC)
	{
		ApBpC.cxx_cxy_cxz_cx() = _mm_add_ps(A.cxx_cxy_cxz_cx(), _mm_add_ps(B.cxx_cxy_cxz_cx(), C.cxx_cxy_cxz_cx()));
		ApBpC.cyy_cyz_cy_czz() = _mm_add_ps(A.cyy_cyz_cy_czz(), _mm_add_ps(B.cyy_cyz_cy_czz(), C.cyy_cyz_cy_czz()));
		ApBpC.cz() = A.cz() + B.cz() + C.cz();
		ApBpC.c () = A.c () + B.c () + C.c ();
	}
	static inline void ApBpC(const V3E3f &A, const V3E3f &B, const V3E3f &C, V3E3f &ApBpC)
	{
		ApBpC.cxxx_cxxy_cxxz_cxx() = _mm_add_ps(A.cxxx_cxxy_cxxz_cxx(), _mm_add_ps(B.cxxx_cxxy_cxxz_cxx(), C.cxxx_cxxy_cxxz_cxx()));
		ApBpC.cxyy_cxyz_cxy_cxzz() = _mm_add_ps(A.cxyy_cxyz_cxy_cxzz(), _mm_add_ps(B.cxyy_cxyz_cxy_cxzz(), C.cxyy_cxyz_cxy_cxzz()));
		ApBpC.cxz_cx_cyyy_cyyz	() = _mm_add_ps(A.cxz_cx_cyyy_cyyz	(), _mm_add_ps(B.cxz_cx_cyyy_cyyz  (), C.cxz_cx_cyyy_cyyz  ()));
		ApBpC.cyy_cyzz_cyz_cy	() = _mm_add_ps(A.cyy_cyzz_cyz_cy	(), _mm_add_ps(B.cyy_cyzz_cyz_cy   (), C.cyy_cyzz_cyz_cy   ()));
		ApBpC.czzz_czz_cz_c		() = _mm_add_ps(A.czzz_czz_cz_c		(), _mm_add_ps(B.czzz_czz_cz_c	   (), C.czzz_czz_cz_c	   ()));
	}
	static inline void AmB(const V3E2f &A, const V3E2f &B, V3E2f &AmB)
	{
		AmB.cxx_cxy_cxz_cx() = _mm_sub_ps(A.cxx_cxy_cxz_cx(), B.cxx_cxy_cxz_cx());
		AmB.cyy_cyz_cy_czz() = _mm_sub_ps(A.cyy_cyz_cy_czz(), B.cyy_cyz_cy_czz());
		AmB.cz() = A.cz() - B.cz();
		AmB.c () = A.c () - B.c ();
	}
	static inline void sA(const float &s, V3E2f &A, __m128 &tmp)
	{
		tmp = _mm_set1_ps(s);
		A.cxx_cxy_cxz_cx() = _mm_mul_ps(tmp, A.cxx_cxy_cxz_cx());
		A.cyy_cyz_cy_czz() = _mm_mul_ps(tmp, A.cyy_cyz_cy_czz());
		A.cz() *= s;
		A.c () *= s;
	}
	static inline void AB(const V3E1f &A, const V3E1f &B, V3E2f &AB, __m128 &tmp)
	{
		AB.cxx_cxy_cxz_cx() = _mm_mul_ps(_mm_set1_ps(A.cx()), B.m_cx_cy_cz_c);

		tmp = _mm_mul_ps(_mm_set1_ps(A.cy()), B.m_cx_cy_cz_c);
		AB.cxy() += tmp.m128_f32[0];
		memcpy(&AB.cyy(), &tmp.m128_f32[1], 12);

		tmp = _mm_mul_ps(_mm_set1_ps(A.cz()), B.m_cx_cy_cz_c);
		AB.cxz() += tmp.m128_f32[0];
		AB.cyz() += tmp.m128_f32[1];
		AB.czz() = tmp.m128_f32[2];

		AB.x_x_cz_c() = _mm_mul_ps(_mm_set1_ps(A.c()), B.m_cx_cy_cz_c);
		AB.cx() += AB.x_x_cz_c().m128_f32[0];
		AB.cy() += AB.x_x_cz_c().m128_f32[1];
		AB.cz() += tmp.m128_f32[3];
	}
	static inline void ABmCD(const V3E1f &A, const V3E1f &B, const V3E1f &C, const V3E1f &D, V3E2f &ABmCD, __m128 &tmp)
	{
		ABmCD.cxx_cxy_cxz_cx() = _mm_sub_ps(_mm_mul_ps(_mm_set1_ps(A.cx()), B.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(C.cx()), D.m_cx_cy_cz_c));

		tmp = _mm_sub_ps(_mm_mul_ps(_mm_set1_ps(A.cy()), B.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(C.cy()), D.m_cx_cy_cz_c));
		ABmCD.cxy() += tmp.m128_f32[0];
		memcpy(&ABmCD.cyy(), &tmp.m128_f32[1], 12);

		tmp = _mm_sub_ps(_mm_mul_ps(_mm_set1_ps(A.cz()), B.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(C.cz()), D.m_cx_cy_cz_c));
		ABmCD.cxz() += tmp.m128_f32[0];
		ABmCD.cyz() += tmp.m128_f32[1];
		ABmCD.czz() = tmp.m128_f32[2];

		ABmCD.x_x_cz_c() = _mm_sub_ps(_mm_mul_ps(_mm_set1_ps(A.c()), B.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(C.c()), D.m_cx_cy_cz_c));
		ABmCD.cx() += ABmCD.x_x_cz_c().m128_f32[0];
		ABmCD.cy() += ABmCD.x_x_cz_c().m128_f32[1];
		ABmCD.cz() += tmp.m128_f32[3];
	}
	static inline void ABpCDpEF(const V3E1f &A, const V3E1f &B, const V3E1f &C, const V3E1f &D, const V3E1f &E, const V3E1f &F, V3E2f &ABpCDpEF, __m128 &tmp)
	{
		ABpCDpEF.cxx_cxy_cxz_cx() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.cx()), B.m_cx_cy_cz_c), 
									_mm_add_ps(_mm_mul_ps(_mm_set1_ps(C.cx()), D.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(E.cx()), F.m_cx_cy_cz_c)));
		tmp = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.cy()), B.m_cx_cy_cz_c), 
			  _mm_add_ps(_mm_mul_ps(_mm_set1_ps(C.cy()), D.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(E.cy()), F.m_cx_cy_cz_c)));
		ABpCDpEF.cxy() += tmp.m128_f32[0];
		memcpy(&ABpCDpEF.cyy(), &tmp.m128_f32[1], 12);

		tmp = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.cz()), B.m_cx_cy_cz_c), 
			  _mm_add_ps(_mm_mul_ps(_mm_set1_ps(C.cz()), D.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(E.cz()), F.m_cx_cy_cz_c)));
		ABpCDpEF.cxz() += tmp.m128_f32[0];
		ABpCDpEF.cyz() += tmp.m128_f32[1];
		ABpCDpEF.czz() = tmp.m128_f32[2];

		ABpCDpEF.x_x_cz_c() = _mm_add_ps(_mm_mul_ps(_mm_set1_ps(A.c()), B.m_cx_cy_cz_c), 
							  _mm_add_ps(_mm_mul_ps(_mm_set1_ps(C.c()), D.m_cx_cy_cz_c), _mm_mul_ps(_mm_set1_ps(E.c()), F.m_cx_cy_cz_c)));
		ABpCDpEF.cx() += ABpCDpEF.x_x_cz_c().m128_f32[0];
		ABpCDpEF.cy() += ABpCDpEF.x_x_cz_c().m128_f32[1];
		ABpCDpEF.cz() += tmp.m128_f32[3];
	}
	static inline void AB(const V3E1f &A, const V3E2f &B, V3E3f &AB, __m128 &tmp1, __m128 &tmp2)
	{
		tmp1 = _mm_set1_ps(A.cx());
		AB.cxxx_cxxy_cxxz_cxx() = _mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx());
		AB.cxyy_cxyz_cxy_cxzz() = _mm_mul_ps(tmp1, B.cyy_cyz_cy_czz());
		AB.cxz() = A.cx() * B.cz();
		AB.cx () = A.cx() * B.c ();

		tmp1 = _mm_set1_ps(A.cy());
		tmp2 = _mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx());
		AB.cxxy() += tmp2.m128_f32[0];	AB.cxyy() += tmp2.m128_f32[1];	AB.cxyz() += tmp2.m128_f32[2];	AB.cxy() += tmp2.m128_f32[3];
		tmp2 = _mm_mul_ps(tmp1, B.cyy_cyz_cy_czz());
		memcpy(&AB.cyyy(), &tmp2, 16);
		AB.cyz() = A.cy() * B.cz();
		AB.cy () = A.cy() * B.c ();

		tmp1 = _mm_set1_ps(A.cz());
		tmp2 = _mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx());
	...
	static inline void ABpCDpEF(const V3E1f &A, const V3E2f &B, const V3E1f &C, const V3E2f &D, const V3E1f &E, const V3E2f &F, V3E3f &ABpCDpEF, 
								__m128 &tmp1, __m128 &tmp2, __m128 &tmp3, __m128 &tmp4)
	{
		tmp1 = _mm_set1_ps(A.cx());		tmp2 = _mm_set1_ps(C.cx());		tmp3 = _mm_set1_ps(E.cx());
		ABpCDpEF.cxxx_cxxy_cxxz_cxx() = _mm_add_ps(_mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx()), 
										_mm_add_ps(_mm_mul_ps(tmp2, D.cxx_cxy_cxz_cx()), _mm_mul_ps(tmp3, F.cxx_cxy_cxz_cx())));
		ABpCDpEF.cxyy_cxyz_cxy_cxzz() = _mm_add_ps(_mm_mul_ps(tmp1, B.cyy_cyz_cy_czz()), 
										_mm_add_ps(_mm_mul_ps(tmp2, D.cyy_cyz_cy_czz()), _mm_mul_ps(tmp3, F.cyy_cyz_cy_czz())));
		ABpCDpEF.cxz() = A.cx() * B.cz() + C.cx() * D.cz() + E.cx() * F.cz();
		ABpCDpEF.cx () = A.cx() * B.c () + C.cx() * D.c () + E.cx() * F.c ();

		tmp1 = _mm_set1_ps(A.cy());		tmp2 = _mm_set1_ps(C.cy());		tmp3 = _mm_set1_ps(E.cy());
		tmp4 = _mm_add_ps(_mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx()), 
			   _mm_add_ps(_mm_mul_ps(tmp2, D.cxx_cxy_cxz_cx()), _mm_mul_ps(tmp3, F.cxx_cxy_cxz_cx())));
		ABpCDpEF.cxxy() += tmp4.m128_f32[0];	ABpCDpEF.cxyy() += tmp4.m128_f32[1];	ABpCDpEF.cxyz() += tmp4.m128_f32[2];	ABpCDpEF.cxy() += tmp4.m128_f32[3];
		tmp4 = _mm_add_ps(_mm_mul_ps(tmp1, B.cyy_cyz_cy_czz()), 
			   _mm_add_ps(_mm_mul_ps(tmp2, D.cyy_cyz_cy_czz()), _mm_mul_ps(tmp3, F.cyy_cyz_cy_czz())));
		memcpy(&ABpCDpEF.cyyy(), &tmp4, 16);
		ABpCDpEF.cyz() = A.cy() * B.cz() + C.cy() * D.cz() + E.cy() * F.cz();
		ABpCDpEF.cy () = A.cy() * B.c () + C.cy() * D.c () + E.cy() * F.c ();

		tmp1 = _mm_set1_ps(A.cz());		tmp2 = _mm_set1_ps(C.cz());		tmp3 = _mm_set1_ps(E.cz());
		tmp4 = _mm_add_ps(_mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx()), 
			   _mm_add_ps(_mm_mul_ps(tmp2, D.cxx_cxy_cxz_cx()), _mm_mul_ps(tmp3, F.cxx_cxy_cxz_cx())));
		...
		tmp1 = _mm_set1_ps(A.c());		tmp2 = _mm_set1_ps(C.c());		tmp3 = _mm_set1_ps(E.c());
		tmp4 = _mm_add_ps(_mm_mul_ps(tmp1, B.cxx_cxy_cxz_cx()), 
			   _mm_add_ps(_mm_mul_ps(tmp2, D.cxx_cxy_cxz_cx()), _mm_mul_ps(tmp3, F.cxx_cxy_cxz_cx())));
	...
	static inline void sA_from_0or1(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		tmp = _mm_set1_ps(s);
		sA.m_sse0 = _mm_mul_ps(tmp, A.m_sse0);
		sA.m_sse1 = _mm_mul_ps(tmp, A.m_sse1);
		sA.m_sse2 = _mm_mul_ps(tmp, A.m_sse2);
		sA.m_sse3 = _mm_mul_ps(tmp, A.m_sse3);
		sA.m_sse4 = _mm_mul_ps(tmp, A.m_sse4);
	}
	static inline void sA_from_2(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
	...
	static inline void sA_from_3(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		sA.v3() = s * A.v3();
		tmp = _mm_set1_ps(s);
		sA.m_sse1 = _mm_mul_ps(tmp, A.m_sse1);
	...
	static inline void sA_from_4or5(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		tmp = _mm_set1_ps(s);
		sA.m_sse1 = _mm_mul_ps(tmp, A.m_sse1);
		sA.m_sse2 = _mm_mul_ps(tmp, A.m_sse2);
	...
	static inline void sA_from_6(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
	...
	static inline void sA_from_7(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		sA.v7() = s * A.v7();
		tmp = _mm_set1_ps(s);
		sA.m_sse2 = _mm_mul_ps(tmp, A.m_sse2);
	...
	static inline void sA_from_8or9(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		tmp = _mm_set1_ps(s);
		sA.m_sse2 = _mm_mul_ps(tmp, A.m_sse2);
		sA.m_sse3 = _mm_mul_ps(tmp, A.m_sse3);
	...
	static inline void sA_from_10(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
	...
	static inline void sA_from_11(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		sA.v11() = s * A.v11();
		tmp = _mm_set1_ps(s);
		sA.m_sse3 = _mm_mul_ps(tmp, A.m_sse3);
	...
	static inline void sA_from_12or13(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA, __m128 &tmp)
	{
		tmp = _mm_set1_ps(s);
		sA.m_sse3 = _mm_mul_ps(tmp, A.m_sse3);
		sA.m_sse4 = _mm_mul_ps(tmp, A.m_sse4);
	...
	static inline void sA_from_14(const float &s, const V3E3fPermutation &A, V3E3fPermutation &sA)
	{
		...
		sA.m_sse4 = _mm_mul_ps(_mm_set1_ps(s), A.m_sse4);
	}
	...
	static inline void AmB_from_19(const V3E3fPermutation &A, const V3E3fPermutation &B, V3E3fPermutation &AmB)
{
	...
	static bool GaussianEliminate(/*V3E3fPermutation A[10], __m128 work[6]*/V3E3fPermutation *A, __m128 *work);
